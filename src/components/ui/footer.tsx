...
//             </ul>
//           </div>
//           <div className="mt-6 text-sm leading-6 text-muted-foreground whitespace-nowrap font-lightlg:mt-0 lg:row-[1/3] lg:col-[1/4]">
...
const tape = (
  <svg
    ...
    fill="none"
  >
    <path d="M1 45L70.282 5L88.282 36.1769L19 76.1769L1 45Z" fill="#3db9ff" />
    <path
    ...
    <footer className="my-8 px-4 max-w-7xl text-white/70 mx-auto">
      ...
      <div className="my-3 px-4 md:px-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-sm text-neutral">
        ...
        <div className="flex gap-4 items-center">
          ...
          >
            <BsGithub className="w-5 h-5 fill-neutral" />
          </a>
          <a
            href="https://twitter.com"
            target="_blank"
            ...
            className="hover:text-gray-900"
          >
            <BsTwitterX className="w-5 h-5 fill-neutral" />
          </a>
        </div>
      </div>
    </footer>
